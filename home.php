          ...
          <div id="slider-carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="item active">
                <div class="col-sm-6">
                  <h1><span>TOWEL</span> OASIS</h1>
                  <h2> BEST OF THE BEST BATH TOWELS</h2>
                  <p>A bath towel is made from cotton, polyester, wool, hemp, ramie, bamboo, linen, or terry cloth. </p>
              ...
              <div class="item">
                <div class="col-sm-6">
                  <h1><span>TOWEL </span>OASIS</h1>
                  <h2>HAND TOWELS, PATRONIZE US</h2>
                  <p> Hand towels are made from several materials like cotton, wool, rayon, bamboo, non-woven fibre, and paper. </p>
              ...
              <div class="item">
                <div class="col-sm-6">
                  <h1><span>TOWEL </span>OASIS</h1>
                  <h2>DO YOU WANT KITCHEN TOWELS ?</h2>
                  <p>Besides drying your hands and countertops, kitchen towels are also a great tool for drying dishes, cutlery, and other utensils. </p>
