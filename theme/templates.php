...
<body style="background-color:aliceblue" onload="totalprice()" >
  ...
  <header id="header"><!--header-->
          ...
          <div class="col-sm-8">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i> 234-81-6834-8832</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i> mr@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-4">
        ...
        <div class="row">
          <div class="col-md-4 clearfix">
            <div class="logo pull-left">
              <a href="<?php echo web_root?>"><img src="images/home/b.jpg" width="100" height="100"
               alt="" /></a>
            </div> 
          </div>
        ...
        <div class="row">
          <div class="col-sm-2">
            <div class="companyinfo">
              <h2><span> Towel e</span>-commerce</h2>
              <p>NOW AVAILABLE!!!</p>
            </div>
          </div>
          <div class="col-sm-7">
    ...
    <div class="footer-widget">
      <div class="container">
        <p>TOWEL AVAILABLE AT YOUR DOOR STEP!!!</p>
        <div class="row">
          <div class="col-sm-3">
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <!-- <p class="pull-left">Modified by <span><a href="https://bit.ly/2LPn9Wu">Maryam Tukur Gwarzo</a></span></p>
          <p class="pull-right">In conjunction with.. <span><a target="_blank" href="http://www.caliphridwan.github.io">Ridwan Abdulkareem</a></span></p> -->
        </div>
      </div>
    </div>
