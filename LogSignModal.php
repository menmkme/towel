                      ...
                      <!-- <h4>Login Tab</h4>  -->
                       <div class="panel panel-pup">
                              ...
                              <input class="proid" type="hidden" name="proid" id="proid" value="">
                                <div class="form-group">
                                  <div class="col-md-10">
                                    ...
                                    <div class="col-md-8">
                                       <input   id="U_USERNAME" name="U_USERNAME" placeholder="Username" type="text" class="form-control input-sm" require> 
                        ...
                        <div class="panel-footer">
                             <p align="left">&copy; <a href="https://bit.ly/2LPn9Wu">TOWEL OASIS</a></p>
                        </div>
                    </div> 
                  </div>
                  <!-- end login panel -->
                                    ...
                                    <div class="panel-heading">
                                     ...
                                     <div class="panel-body">
                                      ...
                                      <!-- <div class="form-group">
                                        <div class="col-md-10">
                                          <label class="col-md-4 control-label" for=
                                          "LNAME">Measurement:</label>

                                          <div class="col-md-8">
                                             <input class="form-control input-sm" id="LNAME" name="LNAME" placeholder=
                                                "Enter Size (e.g 54, 56,58)" type="text" value="">
                                          </div>
                                        </div>
                                      </div> -->
                                        ...
                                        <div class="col-md-10">
                                          ...
                                          <div class="col-md-8">
                                            <input  id="GENDER" name="GENDER" placeholder=
                                                "Gender" type="radio" checked="true" value="Male"><b> Large </b>
                                                <input   id="GENDER" name="GENDER" placeholder=
                                                "Gender" type="radio" value="Female"> <b> Medium </b>
                                          </div>
                                        </div>
                                      </div>
                                      ...
                                      <div class="form-group">
                                       ...
                                       <div class="form-group">
                                        ...
                                        <p>  I <input type="checkbox" id="conditionterms" name="conditionterms" value="checkbox" />
                                           <small>Agree with the <a class="toggle-modal"  onclick=" OpenPopupCenter('terms.php','Terms And Codition','600','600')"  ><b>TERMS AND CONDITION</b></a> of TOWEL OASIS</small>
