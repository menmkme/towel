         ...
         <div class="row">
              ...
              <div class="form-group">
                  ...
                  <div class="radio" >
                      ...
                      <br> <br>
                          <input type="radio"  class="paymethod" name="paymethod" id="deliveryfee" value="Pay Now"  data-toggle="collapse"  data-parent="#accordion" data-target="#collapseOne" >Pay Now 
                          <br> <h3> ACCOUNT DETAILS: </h3> <br> BANK: JAIZ BANK <br> ACCOUNT NUMBER: 0283494758 <br> ACCOUNT NAME: TOWEL OASIS
                          <br> <h3> CONTACT (for more description) </h3> <br> NAME: Somebody <br> CONTACT NUMBER: 09089767532 <br>
                          <br> <h3> CONTACT us (for any request) </h3> <br> NAME: Test <br> CONTACT NUMBER: 08176898765 <br>
                        </label>
                  </div> 
              </div> 
                        <div class="panel"> 
                                    ...
                                    <div class="form-group ">
                                      <label>Address where to deliver</label>
                                        ...
                                        <div class="col-md-12">
                                          ...
                                          "PLACE">Delivery State(Brgy/City):</label>
